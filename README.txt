...
<html lang="en">
    ...
    <body>
        ...
        <main class="container"><!-- Dominant content of the web page -->         
            ...
            <div class="row">
            <article class="col-lg px-5 mb-4"><!-- Self-contained content intended to be independently distributable -->
                ...
                <div class=mt-2>
                Cross the four kilometres in a kayak guided by a local guide. <strong class="text-warning fw-normal"><i class="bi bi-exclamation-triangle"></i>This guided visit is physically demanding, and we recommend it for only those in excellent physical condition.</strong>
            ...
            <article class="col-lg px-5 mb-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><li><span class="fw-bold">Minimum:</span> 4 pax</li>
                </ul>  
                <div class="text-center">
                    <a class="btn btn-primary btn-sm" href="javascript:void(0)">Book here</a> 
            </div>
        ...
        <aside>
            ...
            <h2 class="display-5">Have you travelled to Laguna Brava?</h2>
            <p>
